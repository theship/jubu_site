<section class="portfolio-container" data-md-color-scheme="default">
  ...
  <div class="mdx-spotlight">
      ...
      <figcaption class="md-typeset">
        ...
        <p>The first version of the Planet Labs SDK and CLI for Python project produced an API reference. For version 2.0, we built out the content, opting for a mkdocs-material template that I designed and implemented.
        </p>
        <ul>
          ...
          <li>Wrote critical content for <a href="https://planet-sdk-for-python-v2.readthedocs.io/en/latest/get-started/quick-start-guide/"
                                          ...
                                          >
                                          user guide</a></li>
          <li>Began reorganizing team under new program management</li>
          <li>Designed & developed SVG animation for splash screen</li>
        </ul>
        <p>
          <a href="https://planet-sdk-for-python-v2.readthedocs.io/en/latest/python/sdk-guide/"
    ...
    <figure class="mdx-spotlight__feature">
      ...
      <figcaption class="md-typeset">
        ...
        <p>Planetary Variables through Planet Subscriptions API were new offerings for a new target audience. Giving users code in the form of Python Notebooks meant they could quickly transmit data and begin analysis.
        </p>
        <ul>
          <li>Wrote Python Notebooks demonstrating API for <a href="https://github.com/planetlabs/notebooks/blob/master/jupyter-notebooks/subscriptions_api_tutorial/Biomass_Proxy_PV_Subs_Ohio.ipynb"
            ...
            target="_blank"
            >Soil Water Content</a> Planetary Variables, including using RestFUL API, and specialized libraries, such as Python Pandas, Matplotlib, Rasterio, and Shapely</li>
    ...
    <figure class="mdx-spotlight__feature">
      ...
      <figcaption class="md-typeset">
        ...
        <ul>
          ...
          <li>Developed and edited a subject matter expert <a href="https://developers.planet.com/blog/" target="_blank">developers blog</a></li>
          <li>Provided <a href="https://assets.planet.com/docs/Planet_Combined_Imagery_Product_Specs_letter_screen.pdf" target="_blank">technical editorial support</a> for specialized content</li>
        </ul>
        <p>
